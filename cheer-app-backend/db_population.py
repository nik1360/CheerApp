...
db_insert.insert_user(RegisteredUser('pierre', 'password', 'pierre@mail.com', 'Jesus', 'SwEng', '1996-02-23', 'Pavia',
...
db_insert.insert_organizer(Organizer('jon', 'password', 'jon@mail.com', 'phone', 'Jon', 'Doe', '1996-02-23'))
